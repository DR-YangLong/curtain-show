...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="${staticTools.getResourcePath()}/admin/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">登陆后使用</p>

    <form action="/login" method="post">
      <div class="form-group has-feedback">
        <input name="account" type="email" class="form-control" placeholder="邮箱">
...
<!-- jQuery 2.2.3 -->
<script src="${staticTools.getResourcePath()}/admin/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="${staticTools.getResourcePath()}/bootstrap/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="${staticTools.getResourcePath()}/admin/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
